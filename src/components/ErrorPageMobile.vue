...
<div class="main-error-page">
  ...
  <h1 class="error-title">
    Woops! <br>Actualmente PEUMO no esta optimizada para dispositivos mobiles.
  </h1>
  <h2 class="error-subtitle">
   Vuelve a visitarnos desde una computadora o tablet! <br> Te esperamos!
  </h2>
 <button class="btn-main" type="button" v-on:click="goToStart()">
    Volver al Inicio
  </button>
