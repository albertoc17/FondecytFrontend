export const Analisis = {
  ...
  LexicoGramaticalRepeticionLexica: {
    ...
    feedback_positivo: "Haz producido un buen texto, puesto que no identificamos repetición léxica ¡Sigue así!"
  },
  ...
  EstiloPrimeraPersonaSingular: {
    ...
    ejemplo: "“Para el caso armar otro circuito en paralelo el procedimiento lo encontré un poco más tedioso y terminé por confundirme en como agregar el multímetro para cada elemento, luego con ayuda de tips de la profesora, pude saber cuál parte iba con cuál en la protoboard, despejando esa duda pude empezar a calcular los valores de voltaje y corriente en el circuito”",
  ...
  EstiloSegundaPersonaSingular: {
    ...
    ejemplo: "En la siguiente oración se observa un ejemplo del uso de la segunda persona singular: “Este proceso se repetirá con los diferentes circuitos que se analizarán a lo largo de esta experiencia, pero con la diferencia, que en cada uno de estos se utilizará un método distinto y las variables a encontrar serán distintas, dependiendo de lo que te pida indagar el circuito a analizar respectivamente”. En este caso correspondía emplear la forma impersonal “se”.",
  ...
  EstiloVozPasiva: {
    ...
    ejemplo: "En el siguiente ejemplo se puede observar un uso excesivo de la voz pasiva: “Los datos presentados en la tabla n°1 fueron identificados y presentados mediante el uso de los manuales de cada fabricante los cuales fueron entregados en laboratorio de mediciones.” A continuación se muestra de qué manera se puede reformular: “Se identificaron y presentaron los datos de la tabla n°1 mediante el uso de los manuales de cada fabricante, los cuales se entregaron en el laboratorio de mediciones.”",
    feedback_positivo: "¡Haz realizado un buen trabajo! No identificamos un exceso de voz pasiva en tu texto."
  },
  EstiloConectores: {
    titulo: "Conectores",
    feedback_negativo: "En esta oración, al parecer, no estás empleando ningún conector o marcador discursivo. Te recomendamos que los utilices para que las ideas se relacionen de manera clara y que tu texto sea cohesivo.",
    info: "Los conectores son unidades invariables que establecen conexiones entre las distintas partes de un texto. Sin los marcadores discursivos la oración no cobra sentido, tal como se evidencia en el enunciado que se presenta a continuación: “el multímetro digital entregó mejores resultados en todas las actividades, (por lo que) es un buen candidato para realizar mediciones en futuros laboratorios, (ya que) también necesita menor cantidad de ajustes que un multímetro análogo”.",
    ejemplo: "A continuación, se tiene un ejemplo del mal empleo de un conector: “Previamente al comienzo de la actividad práctica, fueron dados a conocer los riesgos eléctricos y los métodos de protección, se mencionó que en caso de descarga eléctrica en un compañero se debe cortar la corriente desde el interruptor o disyuntor (automático), en este caso instalado en el mesón de trabajo. Por el contrario, nunca se debe tocar a la persona que está recibiendo corriente eléctrica”. Debido a que las ideas no se contraponen sino que se añade otra complementando la anterior, en lugar de utilizar el conector “Por el contrario”, se recomienda utilizar un conector aditivo como “Además” o “Asimismo”.",
    feedback_positivo: "Observamos un buen texto, con un adecuado uso de marcadores discursivos ¡Buen trabajo!"
  }
}